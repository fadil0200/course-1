...
float wout( float qin, float qout)
{
    float wnet;
    wnet=qin-qout;
    return wnet;
}
float nth(float wnet, float qin)
{ 
    float nther;
    nther=wnet/qin*100;
    return nther;
...
{
/*task1*/
float p1_ideal=10 , p2_ideal=3000, p3_ideal=3000, p4_ideal=10,  v1_ideal=0.001010/*from table*/ , mf=20, h1_ideal=191.81,h2_ideal,h3_ideal=3120/*from chart*/
...
wnet_ideal=wout(qin_ideal,qout_ideal);
nther_ideal=nth(wnet_ideal,qin_ideal);
std::cout<<"  "<<std::endl;
...
float h4task2_1=2120;/*from chat*/
float qintask2_1=qin(h3task2_1,h2task2_1);
float qouttask2_1=qout(h4task2_1,h1_ideal);
float wnet_task2_1=wout(qintask2_1,qouttask2_1);
float nther_task2_1=nth(wnet_task2_1,qintask2_1);
std::cout<<"  "<<std::endl;
...
float h3task2_2=3090;/*from chart*/
float h4task2_2=2080;/*from chart*/
float qintask2_2=qin(h3task2_2,h2task2_2);
float qouttask2_2=qout(h4task2_2,h1_ideal);
float wnet_task2_2=wout(qintask2_2,qouttask2_2);
float nther_task2_2=nth(wnet_task2_2,qintask2_2);
std::cout<<"  "<<std::endl;
...
float h4task2_3=2050;/*from chart*/
float qintask2_3=qin(h3task2_3,h2task2_3);
float qouttask2_3=qout(h4task2_3,h1_ideal);
float wnet_task2_3=wout(qintask2_3,qouttask2_3);
float nther_task2_3=nth(wnet_task2_3,qintask2_3);
std::cout<<"  "<<std::endl;
...
float h4task2_4=2030;/*from chart*/
float qintask2_4=qin(h3task2_4,h2task2_4);
float qouttask2_4=qout(h4task2_4,h1_ideal);
float wnet_task2_4=wout(qintask2_4,qouttask2_4);
float nther_task2_4=nth(wnet_task2_4,qintask2_4);
std::cout<<"  "<<std::endl;
...
float h4task3_1=2140;
float qintask3_1=qin(h3_ideal,h2task3_1);
float qouttask3_1=qout(h4task3_1,h1task3_1);
float wnet_task3_1=wout(qintask3_1,qouttask3_1);
float nther_task3_1=nth(wnet_task3_1,qintask3_1);
std::cout<<"  "<<std::endl;
...
float h4task3_2=2110;
float qintask3_2=qin(h3_ideal,h2task3_2);
float qouttask3_2=qout(h4task3_2,h1task3_2);
float wnet_task3_2=wout(qintask3_2,qouttask3_2);
float nther_task3_2=nth(wnet_task3_2,qintask3_2);
std::cout<<"  "<<std::endl;
...
float h4task3_3=2100;
float qintask3_3=qin(h3_ideal,h2task3_3);
float qouttask3_3=qout(h4task3_3,h1task3_3);
float wnet_task3_3=wout(qintask3_3,qouttask3_3);
float nther_task3_3=nth(wnet_task3_3,qintask3_3);
std::cout<<"  "<<std::endl;
...
float h4task3_4=2090;/*from chart*/
float qintask3_4=qin(h3_ideal,h2task3_4);
float qouttask3_4=qout(h4task3_4,h1task3_4);
float wnet_task3_4=wout(qintask3_4,qouttask3_4);
float nther_task3_4=nth(wnet_task3_4,qintask3_4);
std::cout<<"  "<<std::endl;
...
float h4_reheat=2940;/*from chart*/
float h5_reheat=3140;/*from chart*/
float h6_reheat=2260;/*from chart*/
...
float wnet_reheat=wout(qin_reheat,qout_reheat);
float nther_reheat=nth(wnet_reheat,qin_reheat);
std::cout<<"  "<<std::endl;
